...
from config.settings import REPORT_INPUTS_DIR, REPORT_OUTPUT_DIR
...
async def start_assessment(
    ...
    # Create assessment
    assessment_id = create_assessment(ratio_file.filename, model, skip_biz_desc)
...
async def get_past_report(name: str):
    ...
    from config.settings import ASSESSMENTS_DIR
